...
class LinhaController {
    ...
    async store(req, res) {
        try {
            const { numero, nome, sentido, horarios, pontos, cor, passagem, horarioOperacao } = req.body;

            console.log('Dados recebidos para criação:', {
                numero, nome, sentido, cor, passagem, horarioOperacao,
    ...
    async update(req, res) {
        try {
            ...
            console.log('Dados recebidos para atualização:', {
                id, numero, nome, sentido, cor, passagem, horarioOperacao,
                horarios: JSON.stringify(horarios),
                pontos: JSON.stringify(pontos)
            });
